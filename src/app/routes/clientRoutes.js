...
module.exports = (app, keycloak) => {
  ...
  app.all(['/announcement', '/announcement/*', '/search', '/search/*',
    ...
    '/resources/*', '/myActivity', '/myActivity/*', '/org/*', '/manage', '/manage/*', '/contribute', '/contribute/*', '/groups', '/groups/*', '/my-groups', '/my-groups/*', '/certs/configure/*',
    '/observation', '/observation/*', '/solution', '/solution/*', '/questionnaire', '/questionnaire/*', '/uci-admin', '/uci-admin/*', '/program', '/admin-portal', '/admin-portal/*'],
    session({
